...
describe('State Updater Lambda: Custom Resource Create', () => {
    ...
    test('Testing "Create" Custom Resource Action', () => __awaiter(this, void 0, void 0, function* () {
        ...
        }, { getRemainingTimeInMillis: () => { return 10000; } });
...
describe('State Updater Lambda: Manual Invokation', () => {
    ...
    test('Valid event', () => __awaiter(this, void 0, void 0, function* () {
        // Set a 200 response for the Metrics event
        axiosMock.onPost().reply(200);
        axiosMock.onPut().reply((config) => {
            try {
    ...
    test('Missing "TableName" value', () => __awaiter(this, void 0, void 0, function* () {
        const lambdaFunction = require('./state-updater');
        yield lambdaFunction.handler({
            TableName: '',
            AppId: 'app-id',
            NewState: 'active'
        }, {}).catch(err => {
    ...
    test('Missing "AppId" value', () => __awaiter(this, void 0, void 0, function* () {
        const lambdaFunction = require('./state-updater');
        yield lambdaFunction.handler({
            TableName: 'table-name',
            AppId: null,
    ...
    test('Missing "NewState" value', () => __awaiter(this, void 0, void 0, function* () {
        const lambdaFunction = require('./state-updater');
        yield lambdaFunction.handler({
            TableName: 'table-name',
            AppId: 'app-id',
    ...
    test('Invalid "NewState" value', () => __awaiter(this, void 0, void 0, function* () {
        const lambdaFunction = require('./state-updater');
...
//# sourceMappingURL=state-updater.spec.js.map